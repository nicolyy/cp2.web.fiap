...
function init(_a) {
    ...
    function create(info) {
        ...
        ts.createLanguageServiceSourceFile = function (fileName, scriptSnapshot) {
            ...
            if (isCSS(fileName)) {
                scriptSnapshot = (0, getDtsSnapshot_1.getDtsSnapshot)(ts, processor, fileName, scriptSnapshot, options, logger, compilerOptions, directory);
            }
            var sourceFile = _createLanguageServiceSourceFile.apply(void 0, __spreadArray([fileName,
                scriptSnapshot], rest, false));
            if (isCSS(fileName)) {
        ...
        ts.updateLanguageServiceSourceFile = function (sourceFile, scriptSnapshot) {
            ...
            if (isCSS(sourceFile.fileName)) {
                scriptSnapshot = (0, getDtsSnapshot_1.getDtsSnapshot)(ts, processor, sourceFile.fileName, scriptSnapshot, options, logger, compilerOptions, directory);
            }
